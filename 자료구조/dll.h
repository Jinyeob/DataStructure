...
DLL *dll_insert_sort (DLL *i, DLL *first);
...
#else
extern DLL *first, *last;
extern DLL *first, *last;

//extern DLL *dll_make_list_sort (DLL *i, DLL *first);
extern DLL *dll_insert (DLL *item);
extern void dll_display (DLL *info);
extern void dll_show_list (DLL *first);
extern int dll_store_to_file (DLL *first);
extern int dll_load_from_file (DLL *first, DLL *last);
extern DLL *dll_find (char *date); 
extern void dll_delete (char *date); 
